...
export const workerDetailsViewConfig = {
    ...
    "forfeited_history": {
        "is_dated": true,
        "keys": ["item", "quantity", "price", "penalty", "deduction_from_manager", "remarks_from_manager", "underprocessing_value", "remarks_from_proprietor", "final_remarks_from_proprietor", "forfeiture_date", "submit_to_proprietor_date", "info"]
    },
    "on_hold_history": {
        "is_dated": true,
