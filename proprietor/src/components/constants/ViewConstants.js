...
export const proprietorDetailsViewConfig = {
    "on_hold": {
        "is_dated": false,
        "is_grouped": false,
        "keys": ["item", "quantity", "price", "partial_payment", "underprocessing_value", "remarks_from_proprietor", "deduction_from_manager", "remarks_from_manager", "hold_date", "put_on_hold_by", "holding_remarks", "worker", "manager", "hold_info"]
